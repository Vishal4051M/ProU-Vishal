...
import { getTasks, getEmployees, addTask, updateTask, deleteTask } from './lib/store'
...
function App() {
    ...
    const handleSave = (taskData) => {
        if (currentTask) {
            ...
            setTasks(tasks.map(t => t.id === updated.id ? { ...updated, assignee: employees.find(e => e.id === updated.assignee_id) } : t))
        } else {
            const created = addTask(taskData)
            setTasks([
                ...tasks,
                { ...created, assignee: employees.find(e => e.id === created.assignee_id) }
            ])
        }
    }
            ...
            <div className="space-y-8">
                ...
                {currentView === 'TASKS' && (
                    <div className="border-t border-gray-200 pt-8">
                        ...
                        <TaskList tasks={filteredTasks} onEdit={openEditModal} onDelete={handleDelete} />
                    </div>
                )}
